...
func main() {
	...
	http.HandleFunc("/api3/202300353/call-api1", callApi1Handler)
	http.HandleFunc("/api3/202300353/call-api2", callApi2Handler)

	fmt.Println("API3 corriendo en puerto 8080 (VM2)...")
